...
function Navbar() {
    ...
    return (
        <motion.nav
            ...
            className="fixed backdrop-blur z-[999] w-full px-10 py-4 font-['Neue Montreal'] flex justify-between items-center">
            ...
            <div className="links flex gap-6">
                {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map((item, index) => (
                    <a key={index} className={`text-md capitalize font-normal relative w-fit block cursor-pointer 
