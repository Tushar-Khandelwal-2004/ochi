...
function Footer() {
    return (
        <div className="bg-[#F1F1F1] w-full h-full p-12 flex gap-5">
            <div className="w-1/2 h-full flex flex-col justify-between">
                <div className="heading font-custom">
                    <h1 className="uppercase text-[10vw] leading-none -mb-8" >Eye-</h1>
                    <h1 className="uppercase text-[10vw] leading-none -mb-8" >Opening</h1>
                </div>
            ...
            <div className="w-1/2">
                <h1 className="uppercase text-[10vw] leading-none -mb-8 font-custom" >Presentations</h1>
                <div className="details font-custom2 mt-20">
