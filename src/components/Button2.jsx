const Button2 = ({text}) => {
    return (
        <button class="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-transparent px-3 py-1 font-mono text-sm tracking-tight text-black border border-black">
